...
cv::Mat FaceRecognitionClass::prewhitten(cv::Mat input  ){     
    float sum=0.0;
...
int FaceRecognitionClass::initialize(std::string modelfile, std::string root_dir){
...
#ifdef GPU
	ie.SetConfig({ { PluginConfigParams::KEY_CONFIG_FILE, gpu_config } }, "GPU");
#elif CPU
	...
	const int output_data_size = outputDims[0] * outputDims[1];
