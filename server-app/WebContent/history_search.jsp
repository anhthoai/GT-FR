					...
					<div class="tabbable tabbable-custom tabbable-full-width">						
						<div class="tab-content">							
							...
							<div id="tab_1_5" class="tab-pane active">
								<div class="row search-form-default"  style="margin-left:50px;margin-right:50px">
										<div class="col-md-12">
												...
												<div class="row form-group">
													...
													<div class="row">
														...
														<div class="col-md-4">
															...
															<div >
																<input class="form-control" size="16" type="text" id="city1">
															</div>
														</div>
														<div class="col-md-4">
															<label class="control-label">Country</label>
																<select name="country" id="country1" class="select2 form-control">
																	<option value=""></option>
													...
													<div class="row">
														...
														<div class="col-md-3" id="admin_row">
													...
													<div class="row">
														<div class="col-md-3">
															...
															<div class="input-icon">
																<label><input type="checkbox" name="checkbox" value="value" id="verifystatus1">Verified</label>
															</div>
															
														</div>
														<div class="col-md-3">
															<label class="control-label">Accessed From</label>
															<div >
																<input class="form-control" size="16" type="text" placeholder="2018-6-28" id="from1">
															</div>
														</div>
														...
														<div class="col-md-3">
															...
															<div >
																<input class="form-control" size="16" type="text" placeholder="2018-6-28" id="to1">
															</div>
														</div>
													...
													<div class="row" >
														<div class="col-md-4">
															<label class="control-label">&nbsp</label>
															<select name="page_rows" id="page_rows" class="select2 form-control">
														...
														<div class="col-md-4">
															<label class="control-label">&nbsp</label>
															<span class="input-group-btn"></span>
															<button class="btn green" id = "btn_search_prev">
																Prev &nbsp; <i class="m-icon-swapright m-icon-white" ></i>
															</button>
														</div>
														<div class="col-md-4">
															<label class="control-label">&nbsp</label>
															<span class="input-group-btn"></span>
															<button class="btn green" id = "btn_search_next">
...
<script src="assets/scripts/history_search.js"></script>
...
<div id="RegisterPerson" class="modal fade" aria-hidden="true">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="scroller" style="height:400px" data-always-visible="1" data-rail-visible1="1">
					<div class="row">
						<div class="col-md-12" id="register_person_img_panel">
							<label class="control-label">Face 1</label>
							<form id="register_person_uploadphoto" method="POST" enctype="multipart/form-data">
								<div id="register_person_photo_pan" style="width: 164px">
									<img src="assets/img/account.png" id = "register_person_photo"></img>
					...
					<div class="col-md-12">
						<div class="form-group">
							...
							<div class="input-icon">
								<i class="fa fa-font"></i>
								<input class="form-control" size="16" type="text" id = "register_person-name"/>
							</div>
						</div>
						<div class="form-group">
							<label class="control-label">Sex(Optional)</label>
							<select name="register_person-sex" id="register_person-sex" class="select2 form-control">
								<option value=""></option>
								<option value="Male">Male</option>
								<option value="Female">Female</option>
							</select>
						...
						<div class="form-group">
							<label class="control-label">Birthday(Optional)</label>
							<div >
								<input class="form-control" size="16" type="text" placeholder="2018-6-28" id="register_person-birthday">
							</div>
						</div>
						<div class="form-group">
							<label class="control-label">Home(Optional)</label>
							<div class="input-icon">
								<i class="fa fa-home"></i>
								<input class="form-control" size="16" type="text" id="register_person-home"/>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="input-icon">
								<i class="fa fa-envelope"></i>
								<input class="form-control placeholder-no-fix" type="text" id="register_person-email"/>
							</div>
						</div>
						<div class="form-group">
							<label class="control-label">Group</label>
						...
						<div class="form-group">
							...
							<div class="input-icon">
								<i class="fa fa-phone"></i>
								<input class="form-control" size="16" type="text" id="register_person-phone">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="input-icon">
								...
								<input class="form-control placeholder-no-fix" type="text" id="register_person-city_town"/>
							</div>
						</div>
						<div class="form-group">
							<label class="control-label">Country(Optional)</label>
							<select id="register_person-country" class="select2 form-control">
								<option value=""></option>
									<option value="Afghanistan">Afghanistan</option>
									<option value="Albania">Albania</option>
									<option value="Algeria">Algeria</option>
			...
			<div class="modal-footer">
				...
				<button type="button" class="btn green" id="save_person">Save</button>
			</div>
		</div>
	</div>
</div>
