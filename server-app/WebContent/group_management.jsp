					...
					<div class="tabbable tabbable-custom tabbable-full-width">						
						<div class="tab-content">							
							...
							<div id="tab_1_5" class="tab-pane active">
								<div class="row search-form-default" style="margin-left:-10px">
										<div class="col-md-12">
													...
													<div class="row">
														<div class="col-md-12">
															...
															<div class="input-icon">
																...
																<input class="form-control" size="16" type="text" id = "search_group_name"/>
															</div>
														</div>
													</div>
													<div class="row">
														...
														<div class="col-md-6">
															<label class="control-label">&nbsp</label>
															<span class="input-group-btn"></span>
															<button class="btn blue" id = "btn_register">
...
<script src="assets/scripts/group_management.js"></script>
...
<div id="edit_user" class="modal fade" aria-hidden="true">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="scroller" style="height:400px" data-always-visible="1" data-rail-visible1="1">
					<div class="col-md-12" id="edit_user_img_panel">
						<label class="control-label">User Image</label>
						<form id="edit_user_uploadphoto" method="POST" enctype="multipart/form-data"">
							<div id="edit_user_photo_pan" style="width: 164px">
								<img src="assets/img/account.png" id = "edit_user_photo"></img>
								<img src="assets/img/close.png" id = "edit_user_close_btn" style="margin-top: 26px;display:block;position: absolute;left: 15px;top: 0px;"></img>
							</div>
							<span class="btn fileinput-button" id='file-upload' style='margin-top: 7px;margin-left: 34px; color:#7A7A7C;'>
								...
								<input type="file" name="files" id="edit_user_filename">
							</span>
						</form>	
					</div>
					<div class="col-md-12">
						<div class="form-group">
							...
							<div class="input-icon">
								<i class="fa fa-font"></i>
								<input class="form-control placeholder-no-fix" type="text" value=<%=fullname%> id="edit_user_fullname"/>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="input-icon">
								...
								<input class="form-control placeholder-no-fix" type="text" value=<%=email%> id="edit_user_email"/>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="input-icon">
								...
								<input class="form-control placeholder-no-fix" type="text" value=<%=address%> id="edit_user_address"/>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="input-icon">
								...
								<input class="form-control placeholder-no-fix" type="text" value=<%=city%> id="edit_user_city_town"/>
							</div>
						</div>
						<div class="form-group">
							<label class="control-label">Country</label>
							<select id="edit_user_country" class="select2 form-control">
								<option value=""></option>
					...
					<div class="form-group">
						...
						<div class="input-icon">
							<i class="fa fa-user"></i>
							<input class="form-control placeholder-no-fix" type="text" autocomplete="off" value=<%=userid%> id="edit_user_id"/>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="input-icon">
							...
							<input class="form-control placeholder-no-fix" type="password" autocomplete="off" id="edit_user_new_password" placeholder="New Password"/>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="controls">
							<div class="input-icon">
								<i class="fa fa-check"></i>
								<input class="form-control placeholder-no-fix" type="password" autocomplete="off" placeholder="Re-type Your Password" id="edit_user_rpassword"/>
							</div>
						</div>
					</div>				
				</div>
			...
			<div class="modal-footer">
				<button type="button" id="edit_user_close" class="btn default">Close</button>
				<button type="button" class="btn green" id="edit_user_save">Save changes</button>
			</div>
		</div>
	</div>
</div>
...
<div id="edit_group" class="modal fade" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
				...
				<div class="scroller" style="height:100px" data-always-visible="1" data-rail-visible1="1">
					<div class="col-md-12">
						...
						<div class="form-group">
							...
							<div class="input-icon">
								<i class="fa fa-font"></i>
								<input class="form-control placeholder-no-fix" type="text" autocomplete="off" id="edit_group_name"/>
							</div>
						</div>	
					</div>
				</div>
			...
			<div class="modal-footer">
				<button type="button" id="edit_group_close" class="btn default">Close</button>
				<button type="button" class="btn green" id="edit_group_save">Save changes</button>
			</div>
		</div>
	</div>
</div>

<div id="register_group" class="modal fade" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
				<h4 class="modal-title">Register Group</h4>
			</div>
			<div class="modal-body">
				<div class="scroller" style="height:100px" data-always-visible="1" data-rail-visible1="1">
					<div class="col-md-12">
						...
						<div class="form-group">
							...
							<div class="input-icon">
								<i class="fa fa-font"></i>
								<input class="form-control placeholder-no-fix" type="text" autocomplete="off" id="register_group_name"/>
							</div>
						</div>	
					</div>	
				</div>
			...
			<div class="modal-footer">
				<button type="button" id="register_group_close" class="btn default">Close</button>
				<button type="button" class="btn green" id="register_group_save">Save</button>
			</div>
		</div>
	</div>
</div>
