													...
													<div class="row">
														<div class="col-md-12">
															...
															<div class="input-icon">
																...
																<input class="form-control" size="16" type="text" id = "adminid1"/>
															</div>
														</div>
													</div>
													<div class="row">
													...
													<div class="row">
														<div class="col-md-12">
															...
															<div class="input-icon">
																...
																<input class="form-control" size="16" type="text" id="address1">
															</div>
														</div>	
													</div>
													<div class="row">
...
<script src="assets/scripts/admin_search.js"></script>
...
<div id="edit_admin" class="modal fade" aria-hidden="true">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="scroller" style="height:400px" data-always-visible="1" data-rail-visible1="1">
					<div class="col-md-12" id="edit_admin_img_panel">
						<label class="control-label">User Image</label>
						<form id="edit_admin_uploadphoto" method="POST" enctype="multipart/form-data"">
							<div id="edit_admin_photo_pan" style="width: 164px">
								<img src="assets/img/account.png" id = "edit_admin_photo"></img>
								<img src="assets/img/close.png" id = "edit_admin_close_btn" style="margin-top: 26px;display:block;position: absolute;left: 15px;top: 0px;"></img>
							</div>
							<span class="btn fileinput-button" id='file-upload' style='margin-top: 7px;margin-left: 34px; color:#7A7A7C;'>
								...
								<input type="file" name="files" id="edit_admin_filename">
							</span>
						</form>	
					</div>
					<div class="col-md-12">
						<div class="form-group">
							...
							<div class="input-icon">
								<i class="fa fa-font"></i>
								<input class="form-control placeholder-no-fix" type="text" value=<%=fullname%> id="edit_admin_fullname"/>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="input-icon">
								<i class="fa fa-envelope"></i>
								<input class="form-control placeholder-no-fix" type="text" value=<%=email%> id="edit_admin_email"/>
							</div>
						</div>
						<div class="form-group">
							<label class="control-label">Address</label>
							<div class="input-icon">
								...
								<input class="form-control placeholder-no-fix" type="text" value=<%=address%> id="edit_admin_address"/>
							</div>
						</div>
						<div class="form-group">
							<label class="control-label">City/Town</label>
							<div class="input-icon">
								...
								<input class="form-control placeholder-no-fix" type="text" value=<%=city%> id="edit_admin_city_town"/>
							</div>
						</div>
						<div class="form-group">
							<label class="control-label">Country</label>
							<select id="edit_admin_country" class="select2 form-control">
								<option value=""></option>
									<option value="Afghanistan">Afghanistan</option>
									<option value="Albania">Albania</option>
									<option value="Algeria">Algeria</option>
					...
					<div class="form-group">
						...
						<div class="input-icon">
							<i class="fa fa-user"></i>
							<input class="form-control placeholder-no-fix" type="text" autocomplete="off" value=<%=userid%> id="edit_admin_id"/>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="input-icon">
							...
							<input class="form-control placeholder-no-fix" type="password" autocomplete="off" id="edit_admin_new_password" placeholder="New Password"/>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="controls">
							<div class="input-icon">
								<i class="fa fa-check"></i>
								<input class="form-control placeholder-no-fix" type="password" autocomplete="off" placeholder="Re-type Your Password" id="edit_admin_rpassword"/>
							</div>
						</div>
					</div>				
				</div>
			...
			<div class="modal-footer">
				<button type="button" id="edit_admin_close" class="btn default">Close</button>
				<button type="button" class="btn green" id="edit_admin_save">Save changes</button>
			</div>
		</div>
	</div>
</div>
