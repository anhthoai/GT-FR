						...
						<div class="tab-content">							
							...
							<div id="tab_1_5" class="tab-pane active">
								<div class="row search-form-default">
										<!--
										<div class="col-md-3" id="search_img_panel">
											<form id="uploadphoto" method="POST" enctype="multipart/form-data" style="margin-left:30px">
												<div id="photo_pan">
													<img src="assets/img/nophoto.png" id = "search_photo"></img>
													<img src="assets/img/close.png" id = "close_btn"style="margin-left:30px"></img>
												</div>
												...
												<div class="row form-group">
													...
													<div class="row">
														...
														<div class="col-md-4">
															...
															<select name="group_name" id="search_group_name" class="select2 form-control">
																<option value=""></option>
																<option value="Nogroup">Nogroup</option>
															</select>
														</div>
														<div class="col-md-4" id="admin_row">
															<label class="control-label">AdminID</label>
															<div class="input-icon">
																<i class="fa fa-input"></i>
																<input class="form-control" size="16" type="text" id="search_admin_name"/>
															</div>
														</div>
													</div>
													<div class="row">
														<div class="col-md-4">
															...
															<div class="input-icon">
																...
																<input class="form-control placeholder-no-fix" type="text" id="city1"/>
															</div>
														</div>	
														<div class="col-md-4">
															<label class="control-label">Country</label>
															<div class="input-icon">
																<select id="country1" class="select2 form-control">
																	<option value=""></option>
													...
													<div class="row">
														...
														<div class="col-md-4">
															...
															<button class="btn green" id = "btn_search">
																Search &nbsp; <i class="m-icon-swapright m-icon-white" ></i>
															</button>
															<button class="btn yellow" id = "btn_update">
...
<div id="EditPerson" class="modal fade" aria-hidden="true">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="scroller" style="height:400px" data-always-visible="1" data-rail-visible1="1">
					<div class="row">
						<div class="col-md-6" id="edit_person_img_panel">
							<label class="control-label">Face 1</label>
							<form id="edit_person_uploadphoto" method="POST" enctype="multipart/form-data">
								<div id="edit_person_photo_pan" style="width: 164px">
									<img src="assets/img/account.png" id = "edit_person_photo"></img>
									<img src="assets/img/close.png" id = "edit_person_close_btn" style="margin-top: 26px;display:block;position: absolute;left: 15px;top: 0px;"></img>
								</div>
								<span class="btn fileinput-button" id='file-upload' style='margin-top: 7px;margin-left: 34px; color:#7A7A7C;'>
									<i class="fa fa-fw fa-plus"></i>Add Face
									<input type="file" name="files" id="edit_person_filename">
								</span>
							</form>	
						</div>
						
						<div class="col-md-6" id="edit_person_img_panel1">
							<label class="control-label">Face 2</label>
							<form id="edit_person_uploadphoto1" method="POST" enctype="multipart/form-data">
								<div id="edit_person_photo_pan1" style="width: 164px">
									<img src="assets/img/account.png" id = "edit_person_photo1"></img>
									<img src="assets/img/close.png" id = "edit_person_close_btn1" style="margin-top: 26px;display:block;position: absolute;left: 15px;top: 0px;"></img>
								</div>
								<span class="btn fileinput-button" id='file-upload1' style='margin-top: 7px;margin-left: 34px; color:#7A7A7C;'>
									<i class="fa fa-fw fa-plus"></i>Add Face
									<input type="file" name="files" id="edit_person_filename1">
								</span>
							</form>	
						</div>
					</div>
					<div class="row">
						<div class="col-md-6" id="edit_person_img_panel2">
							<label class="control-label">Face 3</label>
							<form id="edit_person_uploadphoto2" method="POST" enctype="multipart/form-data">
								<div id="edit_person_photo_pan" style="width: 164px">
									<img src="assets/img/account.png" id = "edit_person_photo2"></img>
									<img src="assets/img/close.png" id = "edit_person_close_btn2" style="margin-top: 26px;display:block;position: absolute;left: 15px;top: 0px;"></img>
								</div>
								<span class="btn fileinput-button" id='file-upload2' style='margin-top: 7px;margin-left: 34px; color:#7A7A7C;'>
									<i class="fa fa-fw fa-plus"></i>Add Face
									<input type="file" name="files" id="edit_person_filename2">
								</span>
							</form>	
						</div>
						
						<div class="col-md-6" id="edit_person_img_panel3">
							<label class="control-label">Full Image</label>
							<form id="edit_person_uploadphoto3" method="POST" enctype="multipart/form-data">
								<div id="edit_person_photo_pan" style="width: 164px">
									<img src="assets/img/account.png" id = "edit_person_photo3"></img>
									<img src="assets/img/close.png" id = "edit_person_close_btn3" style="margin-top: 26px;display:block;position: absolute;left: 15px;top: 0px;"></img>
								</div>
								<span class="btn fileinput-button" id='file-upload3' style='margin-top: 7px;margin-left: 34px; color:#7A7A7C;'>
									<i class="fa fa-fw fa-plus"></i>Add Face
									<input type="file" name="files" id="edit_person_filename3">
								</span>
							</form>	
						</div>
					</div>
					...
					<div class="col-md-12">
						<div class="form-group">
							...
							<div class="input-icon">
								<i class="fa fa-font"></i>
								<input class="form-control" size="16" type="text" id = "edit_person-name"/>
							</div>
						</div>
						<div class="form-group">
							<label class="control-label">Sex</label>
							<select name="edit_person-sex" id="edit_person-sex" class="select2 form-control">
								<option value=""></option>
								<option value="Male">Male</option>
								<option value="Female">Female</option>
							</select>
						...
						<div class="form-group">
							<label class="control-label">Birthday</label>
							<div >
								<input class="form-control" size="16" type="text" placeholder="2018-6-28" id="edit_person-birthday">
							</div>
						</div>
						<div class="form-group">
							<label class="control-label">Home</label>
							<div class="input-icon">
								<i class="fa fa-home"></i>
								<input class="form-control" size="16" type="text" id="edit_person-home"/>
							</div>
						</div>
						<div class="form-group">
							<div class="form-group">
								<label class="control-label">Group</label>
								<select name="group_name" id="edit_group_name" class="select2 form-control">
									<option value=""></option>
									<option value="Nogroup">Nogroup</option>
								</select>
							</div>
							<div class="form-group" id="edit_admin_row">
								<label class="control-label">AdminID</label>
								<div class="input-icon">
									<i class="fa fa-input"></i>
									<input class="form-control" size="16" type="text" id="edit_admin_name"/>
								</div>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="input-icon">
								<i class="fa fa-envelope"></i>
								<input class="form-control placeholder-no-fix" type="text" id="edit_person-email"/>
							</div>
						</div>
						<div class="form-group">
							<label class="control-label">Phone</label>
							<div class="input-icon">
								<i class="fa fa-phone"></i>
								<input class="form-control" size="16" type="text" id="edit_person-phone">
							</div>
						</div>
						<div class="form-group">
							<label class="control-label">City/Town</label>
							<div class="input-icon">
								<i class="fa fa-location-arrow"></i>
								<input class="form-control placeholder-no-fix" type="text" id="edit_person-city_town"/>
							</div>
						</div>
						<div class="form-group">
							<label class="control-label">Country</label>
							<select id="edit_person-country" class="select2 form-control">
								<option value=""></option>
									<option value="Afghanistan">Afghanistan</option>
									<option value="Albania">Albania</option>
									<option value="Algeria">Algeria</option>
			...
			<div class="modal-footer">
				<button type="button" id="close_person" class="btn default">Close</button>
				<button type="button" class="btn green" id="save_person">Save changes</button>
			</div>
		</div>
	</div>
</div>
