...
<head>
<meta charset="utf-8"/>
<title>FaceData registerer | Results</title>
						...
						<div class="tab-content">							
							...
							<div id="tab_1_5" class="tab-pane active">
								<div class="row register-form-default">
										...
										<div class="col-md-3" id="register_img_panel1">
											<form id="uploadphoto1" method="POST" enctype="multipart/form-data" style="margin-left:30px">
												<div id="photo_pan">
													<img src="assets/img/nophoto_register.png" id = "register_photo1"></img>
													<img src="assets/img/close.png" id = "close_btn1"style="margin-left:30px;display:block;position: absolute;left: 15px;top: 0px;"></img>
												</div>
												<span class="btn fileinput-button" id='file-upload1' style='margin-top: 7px;margin-left: 34px; color:#7A7A7C;'>
													<i class="fa fa-fw fa-plus"></i>Add Face
													<input type="file" name="files" id="filename1">
												</span>
											</form>	
										</div>
										<div class="col-md-3" id="register_img_panel2">
											<form id="uploadphoto2" method="POST" enctype="multipart/form-data" style="margin-left:30px">
												<div id="photo_pan">
													<img src="assets/img/nophoto_register.png" id = "register_photo2"></img>
													<img src="assets/img/close.png" id = "close_btn2"style="margin-left:30px;display:block;position: absolute;left: 15px;top: 0px;"></img>
												</div>
												<span class="btn fileinput-button" id='file-upload2' style='margin-top: 7px;margin-left: 34px; color:#7A7A7C;'>
													<i class="fa fa-fw fa-plus"></i>Add Face
													<input type="file" name="files" id="filename2">
												</span>
											</form>	
										</div>
										<div class="col-md-3" id="register_img_panel3">
											<form id="uploadphoto3" method="POST" enctype="multipart/form-data" style="margin-left:30px">
												<div id="photo_pan">
													<img src="assets/img/nophoto_register.png" id = "register_photo3"></img>
													<img src="assets/img/close.png" id = "close_btn3"style="margin-left:30px;display:block;position: absolute;left: 15px;top: 0px;"></img>
												</div>
												<span class="btn fileinput-button" id='file-upload3' style='margin-top: 7px;margin-left: 34px; color:#7A7A7C;'>
													<i class="fa fa-fw fa-plus"></i>Add Full Image
													<input type="file" name="files" id="filename3">
												</span>
											</form>	
										</div>
								</div>
								<div class="row register-form-default1"   style="margin-left:30px;margin-top:30px">
								<div class="col-md-12">
												...
												<div class="row form-group">
													...
													<div class="row">
														...
														<div class="col-md-6">
															...
															<select name="group_name" id="register_group_name" class="select2 form-control">
																<option value=""></option>
															</select>
														</div>
													</div>
													...
													<div class="row">
														...
														<div class="col-md-4" id="admin_row">
															<label class="control-label">Admin ID (required)</label>
															<select name="adminid" id="register_admin_name" class="select2 form-control">
																<option value=""></option>
															</select>
														</div>		
														<div class="col-md-4">
...
jQuery(document).ready(function() {    
   ...
   Register.init();
 	...
 	<%		
		if(fullname != null){	
			String success_toast="ShowToast('success', 'You are able to register and register any faces freely.','Wecome to "+fullname+"!', 'toast-top-right');";%>
			<%		
